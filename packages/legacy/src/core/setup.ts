...
import type { Transaction, WalletBehaviourFactory, WalletModuleFactory } from "@near-wallet-selector/core";
import { getNetworkPreset, tryGetSignInData } from "../utils/selector-utils";
 ...
 * @param root0
 */
const Keypom: WalletBehaviourFactory<KeypomWalletInstant, KeypomInitializeOptions> = async ({ logger, keypomWallet }) => {
 ...
 * @param params
 */
export function setupOneClickConnect(params: OneClickParams): WalletModuleFactory<KeypomWalletInstant> {
    return async () => {
